...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        OperacionesTelevisor opTvs = new OperacionesTelevisor();
        ...
        opTvs.establecerTelevisores(tvs);
        opTvs.establecerMarcasVendidas(tvs);
        opTvs.establecerTotalPrecioTvs();
        
        System.out.println("-----------------");
        System.out.printf("%s\n", opTvs.obtenerMarcasVendidas());
        System.out.println(opTvs);
